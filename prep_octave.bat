...
C:\"Program Files"\GnuWin32\bin\wget http://alainplattner.net/COASTS/Greenland.mat
C:\"Program Files"\GnuWin32\bin\wget http://alainplattner.net/COASTS/Ellesmere.mat
